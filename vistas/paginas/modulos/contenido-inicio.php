<?php
	...
	//echo '<pre class="bg-white">'; print_r($anuncios); echo '</pre>';
?>
		...
		<div class="row">
				...
				<div class="row">
					...
					<div class="col-12 col-lg-5">
						...
						<a href="<?php echo $blog["dominio"].$value["ruta_categoria"]."/".$value["ruta_articulo"]; ?>">
							<h5 class="d-block d-lg-none py-3"><?php echo $value["titulo_articulo"]; ?></h5></a>
			...
			<div class="d-none d-md-block pt-md-4 pt-lg-0 col-md-4 col-lg-3">
				...
				<div class="sobreMi">
					...
					<img src="<?php echo $blog["servidor"]."vistas/img/sobreMi.jpg" ;?>" alt="Lorem ipsum dolor sit amet" class="img-fluid my-1">
				...
				<div class="my-4">
					...
					<?php foreach ($articulosDestacados as $key => $value): 
						...
						<div class="w-100 w-xl-50 pr-3 pt-2">
							...
							<a href="<?php echo $blog["dominio"].$categoria["ruta_categoria"]."/".$value["ruta_articulo"]; ?>" class="text-secondary">
