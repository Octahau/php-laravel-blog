...
if(isset($rutas[0])){
    ...
    if (!empty($articulos)) {
        ...
        echo '<script>window.location = "'.$blog["dominio"].'error404";</script>';
        return;
    }
        ...
        <div class="row">
                    ...
                    <?php foreach ($articulos as $value): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-5">
                                ...
                                <a href="<?php echo $blog["dominio"].$value["ruta_categoria"]."/".$value["ruta_articulo"]; ?>">
                                    <img src="<?php echo $blog["servidor"].$value["portada_articulo"]; ?>" alt="<?php echo $value["titulo_articulo"]; ?>" class="img-fluid" width="100%">
                                </a>
                            </div>
            ...
            <div class="d-none d-md-block pt-md-4 pt-lg-0 col-md-4 col-lg-3">
                ...
                <div>
                    ...
                    <?php 
                        $tags = !empty($articulos) ? json_decode($articulos[0]["p_claves_categoria"], true) : []; 
                    ?>
                ...
                <div class="my-4">
                    ...
                    <?php foreach ($articulos as $value): ?>
                        <?php $categoria = ControladorBlog::ctrMostrarCategorias("id_categoria", $value["id_cat"]); ?>
