		...
		<div class="row">
			...
			<div class="col-10 col-sm-11 col-md-8 pt-1 pt-lg-3 p-xl-0">
				...
				<a href="<?php echo $blog["dominio"];?>">
					...
					<img src="<?php echo $blog["servidor"].$blog["logo"] ;?>" alt="Logo de Juanito Travel" class="img-fluid logotipo">
						...
						foreach ($redesSociales as $value) {
							...
							<li>
								<a href="' . htmlspecialchars($value['url']) . '" target="_blank">
									<i class="' . htmlspecialchars($value['icono']) . ' lead rounded-circle text-white mr-1"></i>
								</a>
							</li>';
						}
					?>
