                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="dominio" value="{{$item->dominio}}" required>
                      </div>
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">Servidor</span>
                        </div>
                        <input type="text" class="form-control" name="servidor" value="{{$item->servidor}}" required>
                      </div>
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">Titulo</span>
                        </div>
                        <input type="text" class="form-control" name="titulo" value="{{$item->titulo}}" required>
                      </div>
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                      ...
                      <div class="row">
                        ...
                        <div class="col-2">
                          <button type="button" class="btn btn-primary w-100 agregarRed" id="agregar_red">Agregar</button>
                        </div>
                      </div>
                      <div class="row listadoRed">
                        @php

                        echo"<input type='hidden' name='redes_sociales' id='listaRed' value='".$item->redes_sociales."'>";
                      ...
                      <div class="form-group">
                        <label>Sobre mí <span class="small">(Introduccion)</span></label>                      
                    ...
                    <div class="card-body text-center">
                      <div class="form-group my-2">
                        <div class="btn btn-default btn-file mb-3">
                          ...
                          <input type="hidden" name="logo_actual" value="{{$item->logo}}">
                        </div>
                        <img src="{{url('/')}}/{{$blog[0]["logo"]}}" class="img-fluid py-2 bg-secondary previsualizarImg_logo">
                        <p class="help-block small">Dimensiones: 700px x 200px | Peso Max: 2MB | Formato: JPG o PNG</p>
                      </div>

                      <div class="form-group my-2">
                        <div class="btn btn-default btn-file mb-3">
                          <i class="fas fa-paperclip"></i> Adjuntar imagen del icono
                          <input type="file" name="icono">
                          <input type="hidden" name="icono_actual" value="{{$item->icono}}">
                        </div>
                        <img src="{{url('/')}}/{{$blog[0]["icono"]}}" class="img-fluid py-2 bg-secondary previsualizarImg_icono">
                        <p class="help-block small">Dimensiones: 144px x 144px | Peso Max: 2MB | Formato: JPG o PNG</p>
                      </div>
                      ...
                      <div class="form-group my-2">
                        <div class="btn btn-default btn-file mb-3">
                          ...
                          <input type="hidden" name="portada_actual" value="{{$item->portada}}">
                        </div>
                        <img src="{{url('/')}}/{{$blog[0]["portada"]}}" class="img-fluid py-2 bg-secondary previsualizarImg_portada">
                        <p class="help-block small">Dimensiones: 700px x 420px | Peso Max: 2MB | Formato: JPG o PNG</p>
                      </div>
                      <div class="form-group">
                        <label>Sobre mí <span class="small">(completo)</span></label>
