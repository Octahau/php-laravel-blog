                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered table-striped dt-responsive"
                                                id="tablaAdministradores" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Nombre</th>
                            ...
                            <div class="modal" id="editarAdministrador">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <!-- Modal Header -->
                                        <form method="POST"
                                            action="{{ url('/') }}/administradores/{{ $value['id'] }}"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    @enderror
                                                    <input type="hidden" name="password_actual"
                                                ...
                                                <div class = "form-group my-2 text-center">
                                                    ...
                                                    <br>
                                                    @if ($value['foto'] == '')
                                                        <img src="{{ url('/') }}/img/Administradores/default.jpg"
                                                    ...
                                                    @else
                                                        <img src="{{ url('/') }}/{{ $value['foto'] }}"
                                                            ...
                                                            alt="imagen del administrador">
                                                    @endif
                                                    <input type="hidden" value="{{ $value['foto'] }}"
                                                        name="foto_actual">
                                                    <p class="help-block small">Dimensiones 200px x 200px | Peso Max 2MB |
                                                        Formato JPG o PNG</p>
                                                </div>
                                            </div>
                                            <!-- Modal footer -->
